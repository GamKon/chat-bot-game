#https://huggingface.co/TheBloke/LLaMA2-13B-Psyfighter2-AWQ

from transformers import AutoModelForCausalLM, AutoTokenizer, TextStreamer
from accelerate.utils import release_memory
import torch

async def AWQ_LLaMA2_13B_Psyfighter2(prompt_to_llm: str, max_new_tokens: int):

    if max_new_tokens <= 20 and max_new_tokens >= 2048: max_new_tokens = 256
    print("1----------------------------------------------prompt TO LLaMA2-13B-Psyfighter2-AWQ-----------------------------------------")
    print(prompt_to_llm)
    print("2---------------------------------------------------------------------------------------------------------------")
    ...
    print("3----------------------------------------------raw output FROM LLaMA2-13B-Psyfighter2-AWQ-----------------------------------------------------")
